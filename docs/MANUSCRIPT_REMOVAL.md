# Manuscript download removal

On 6 September 2026, the authors requested removal of the old manuscript and supplementary documents from public downloads. The current branch no longer distributes the old Word/PDF manuscript, Markdown manuscript copies, or supplementary MD/PDF/TeX files. The three corresponding v1.0.0 release attachments were removed separately.

The latest submitted manuscript remains in the authors' local archive. Research implementation, frozen experimental records, numerical summaries, bibliography metadata, figures and their source data remain available. This change does not alter reported experimental results or software/data licensing.
